...
public enum EmotionType {
    ...
    public static EmotionType fromStoredValue(String value) {
        ...
        return switch (normalized) {
            ...
            // 기존 DB에 남아 있을 수 있는 레거시 값은 가장 가까운 '당황'으로 읽습니다.
            case "혼란", "CONFUSION" -> EMBARRASSMENT;
