...
export const MOCK_MY_PAGE_USER_RESPONSE = {
  ...
  nickname: '김철수',
  birth: '2000-05-12',
  profile_img_url: createMockProfileImage(),
  status_msg: '오늘도 잘 부탁해 ♡',
  created_at: '2026-01-10T10:00:00',
  updated_at: '2026-07-20T18:30:00',
  status: 'ACTIVE',
}

export const MOCK_MY_PAGE_COUPLE_MEMBER_RESPONSE = {
  user_id: 1,
  couple_room_id: 1,
  partner_nick: '영희',
  status: 'MATCHED',
  matched_at: '2026-02-14',
}